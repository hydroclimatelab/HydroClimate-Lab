...
const LAB_DATA = {
  ...
  research: [
    ...
    },
    {
      ...
      desc: "Multi-index drought assessment using satellite remote sensing (MODIS, GRACE, GPM) across India. Recent work on enhancing drought assessment in Rajasthan using integrated remote sensing indices published in Earth & Space Science (2024).",
      tag: "Active",
    },
    {
      icon: "🌍",
    ...
    },
    {
      ...
      desc: "Application of machine learning, deep learning, and geoinformatics for climate prediction, crop water stress detection (spectral reflectance studies), and agro-informatics. Part of IIT KGP's Agro-Informatics training initiative.",
      tag: "Growing",
    },
    {
      icon: "🏔",
