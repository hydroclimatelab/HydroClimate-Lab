...
function formatCitation(pub) {
    ...
    citation += `<em>${pub.publication}</em>`;
...
function updateStats() {
    ...
    if (statsContainer && typeof stats !== 'undefined') {
        statsContainer.innerHTML = `
            <div class="stat-item">
                <span class="stat-number">${stats.totalPublications}</span>
                <span class="stat-label">Total Publications</span>
            </div>
            <div class="stat-item">
                <span class="stat-number">${stats.totalJournals}</span>
                <span class="stat-label">Journal Articles</span>
            </div>
            <div class="stat-item">
                <span class="stat-number">${stats.totalConferences}</span>
